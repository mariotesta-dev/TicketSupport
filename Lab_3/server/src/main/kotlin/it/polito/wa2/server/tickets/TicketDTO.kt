...
fun Ticket.toDTO() : TicketDTO {
    return TicketDTO(id, product.toDTOWithoutWarranty(), customer?.toDTOWithoutWarrantiesAndTickets(), assignedTo, category, summary, description, priority, createdAt)
}
...
fun Ticket.toDTO(history: Status?) : TicketDTO {
    return TicketDTO(id, product.toDTOWithoutWarranty(), customer?.toDTOWithoutWarrantiesAndTickets(), assignedTo, category, summary, description, priority, createdAt, history)
}
